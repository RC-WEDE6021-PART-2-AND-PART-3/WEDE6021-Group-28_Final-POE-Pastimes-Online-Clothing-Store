...
<div style="margin-bottom:1rem;">
    <a href="add_listing.php" class="btn btn-primary" style="padding:0.5rem 0.75rem;">+ Add Listing</a>
</div>
            ...
            <tr>
                ...
                <td>
                    <div class="action-buttons">
                        ...
                        <?php endif; ?>
                        <a href="edit_listing.php?clothingID=<?php echo $listing['clothingID']; ?>" class="btn-edit" style="padding:0.4rem 0.8rem; background:#e0f2fe; color:#0369a1; border-radius:4px; text-decoration:none; font-weight:600;">Edit</a>
