...
('Super Admin', 'admin@pastimes.co.za', 'admin', md5('Admin1234')),
('Jane Mokoena', 'j.mokoena@pastimes.co.za', 'jmokoena', md5('Admin1234')),
('Dev Admin', 'dev@pastimes.co.za', 'devadmin', md5('Admin1234'));
...
('Sheketli Mochaki', 's.mocha@abc.co.za', 's.mocah', md5('Pass1234'), 'buyer', 'active', '12 Main Road', 'Cape Town', '8001', '0821234567'),
('Lufuno Makhado', 'l.makhado@gmail.com', 'l.makhado', md5('Pass1234'), 'seller', 'active', '45 Oak Avenue', 'Johannesburg', '2001', '0839876543'),
('Katlego Joshua', 'm.johnson@outlook.com', 'K.Joshua', md5('Pass1234'), 'both', 'active', '78 Pine Street', 'Pretoria', '0001', '0845551234'),
('Priya Naidoo', 'p.naidoo@webmail.co.za', 'priya_n', md5('Pass1234'), 'buyer', 'pending', '5 Rose Avenue', 'Durban', '4001', '0761234567'),
('Lebo Dlamini', 'lebo.d@ymail.com', 'lebod', md5('Pass1234'), 'seller', 'active', '22 Jacaranda Lane', 'Bloemfontein', '9301', '0829998877'),
('Thabo Nkosi', 'thabo.n@email.com', 'thabo_n', md5('Pass1234'), 'seller', 'active', '15 Nelson Mandela Dr', 'Soweto', '1804', '0831112233'),
('Aisha Patel', 'aisha.p@gmail.com', 'aisha_p', md5('Pass1234'), 'both', 'active', '8 Sandton Drive', 'Sandton', '2196', '0844445566'),
('Sipho Mokoena', 'sipho.m@outlook.com', 'sipho_m', md5('Pass1234'), 'buyer', 'active', '33 Church Street', 'Polokwane', '0700', '0857778899'),
('Zanele Khumalo', 'zanele@example.com', 'zanele_k', md5('Pass1234'), 'buyer', 'pending', '19 Freedom Way', 'East London', '5201', '0866661122'),
('Lerato Dlamini', 'lerato.d@mail.co.za', 'lerato_d', md5('Pass1234'), 'buyer', 'active', '12 Jacaranda Street', 'Pretoria', '0001', '0823334455'),
('Mandla Sithole', 'mandla.s@email.com', 'mandla_s', md5('Pass1234'), 'seller', 'active', '67 Market Street', 'Johannesburg', '2001', '0834567890'),
('Nomsa Zwane', 'nomsa.z@gmail.com', 'nomsa_z', md5('Pass1234'), 'both', 'active', '45 Beach Road', 'Durban', '4001', '0847890123'),
('Bongani Mahlangu', 'bongani.m@yahoo.com', 'bongani_m', md5('Pass1234'), 'buyer', 'active', '23 Mountain View', 'Cape Town', '8001', '0851234567'),
('Naledi Molefe', 'naledi.m@outlook.com', 'naledi_m', md5('Pass1234'), 'seller', 'active', '89 Sunset Boulevard', 'Pretoria', '0002', '0862345678'),
('Themba Ndlovu', 'themba.n@mail.com', 'themba_n', md5('Pass1234'), 'buyer', 'suspended', '12 Railway Street', 'Port Elizabeth', '6001', '0873456789'),
('Palesa Mosia', 'palesa.m@email.co.za', 'palesa_m', md5('Pass1234'), 'both', 'active', '56 Gold Street', 'Johannesburg', '2001', '0884567890'),
('Kagiso Tau', 'kagiso.t@gmail.com', 'kagiso_t', md5('Pass1234'), 'seller', 'active', '34 Diamond Road', 'Kimberley', '8301', '0895678901'),
('Dineo Radebe', 'dineo.r@yahoo.com', 'dineo_r', md5('Pass1234'), 'buyer', 'active', '78 Emerald Lane', 'Bloemfontein', '9301', '0826789012'),
('Siyanda Cele', 'siyanda.c@outlook.com', 'siyanda_c', md5('Pass1234'), 'both', 'pending', '90 Ruby Avenue', 'Durban', '4001', '0837890123'),
('Mpho Langa', 'mpho.l@email.com', 'mpho_l', md5('Pass1234'), 'seller', 'active', '11 Sapphire Street', 'Soweto', '1804', '0848901234'),
('Thandeka Ngcobo', 'thandeka.n@gmail.com', 'thandeka_n', md5('Pass1234'), 'buyer', 'active', '22 Pearl Road', 'Pietermaritzburg', '3201', '0859012345'),
('Lindani Mthembu', 'lindani.m@mail.co.za', 'lindani_m', md5('Pass1234'), 'both', 'active', '33 Coral Lane', 'Richards Bay', '3900', '0860123456'),
('Nokuthula Zulu', 'nokuthula.z@yahoo.com', 'nokuthula_z', md5('Pass1234'), 'seller', 'active', '44 Amber Street', 'Newcastle', '2940', '0871234567'),
('Vusi Shabangu', 'vusi.s@outlook.com', 'vusi_s', md5('Pass1234'), 'buyer', 'active', '55 Jade Avenue', 'Nelspruit', '1200', '0882345678'),
('Ayanda Mkhize', 'ayanda.m@email.com', 'ayanda_m', md5('Pass1234'), 'both', 'active', '66 Opal Road', 'Rustenburg', '0299', '0893456789'),
('Sbongile Dube', 'sbongile.d@gmail.com', 'sbongile_d', md5('Pass1234'), 'seller', 'pending', '77 Topaz Lane', 'Mahikeng', '2745', '0824567890'),
('Nhlanhla Koza', 'nhlanhla.k@yahoo.com', 'nhlanhla_k', md5('Pass1234'), 'buyer', 'active', '88 Crystal Street', 'Upington', '8800', '0835678901'),
('Busisiwe Ndaba', 'busisiwe.n@mail.com', 'busisiwe_n', md5('Pass1234'), 'both', 'active', '99 Onyx Avenue', 'George', '6529', '0846789012'),
('Lwazi Gumede', 'lwazi.g@outlook.com', 'lwazi_g', md5('Pass1234'), 'seller', 'active', '10 Quartz Road', 'Grahamstown', '6139', '0857890123'),
('Zinhle Maseko', 'zinhle.m@email.com', 'zinhle_m', md5('Pass1234'), 'buyer', 'active', '21 Granite Lane', 'Worcester', '6850', '0868901234');
