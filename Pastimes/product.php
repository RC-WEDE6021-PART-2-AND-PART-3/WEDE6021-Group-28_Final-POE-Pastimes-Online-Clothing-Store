...
<div class="product-container">
    ...
    <div class="product-gallery">
        <div class="product-main-image">
              <img src="<?php echo htmlspecialchars(image_url(!empty($product['imagePath']) ? $product['imagePath'] : '', $product['category'])); ?>" 
        ...
        <article class="product-card">
            <div class="product-image">
                ...
                <a href="product.php?id=<?php echo $item['clothingID']; ?>">
                    <img src="<?php echo htmlspecialchars(image_url(!empty($item['imagePath']) ? $item['imagePath'] : '', $item['category'])); ?>" 
